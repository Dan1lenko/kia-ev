...
function SocialLink({
  ...
  return (
    <a
      href={href}
      aria-label={label}
      className="flex h-9 w-9 items-center justify-center rounded-full bg-gray-700/50 text-gray-400 transition-all duration-200 hover:bg-primary hover:text-white"
    >
      {icons[icon]}
    </a>
  );
